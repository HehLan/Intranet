                    ...
                    if ($nbrmatch > 0) {
                        ...
                        for ($c = $niveau; $c >= 0; $c--) {
                            ...
                            for ($m = 1; $m <= $match_par_niveau[$c]; $m++) {
                                ...
                                if ($c == 0) {
                                    if ($m == 1)
                                        echo '<tr class="tr_arbre_vide"><td class="td_finale_vide" colspan="3">FINALE</td></tr>';
                                    if ($m == 2)
                                        echo '<tr class="tr_arbre_vide"><td class="td_finale_vide" colspan="3">Petite Finale</td></tr>';
                                    $fleche = '';
                                }
                                if ($score1 == '')
                            ...
                            for ($m = 1; $m <= $match_par_niveau[$c]; $m++) {
                                ...
                                for ($j = 1; $j <= $maxj; $j++) {
                                    ...
                                    if ($j == 1) {
                                        if ($c == 0) {
                                            if ($m == 1)
                                                echo '<tr class="tr_arbre_vide"><td class="td_finale_vide" colspan="' . ($matches[$tablo[$c][$m]]['nbr_manche'] + 4) . '">FINALE<br>' . $heure . '</td></tr>';
                                            if ($m == 2)
                                                echo '<tr class="tr_arbre_vide"><td class="td_finale_vide" colspan="' . ($matches[$tablo[$c][$m]]['nbr_manche'] + 4) . '">Petite Finale<br>' . $heure . '</td></tr>';
                                            $fleche = '';
                                        }
                                        else {
