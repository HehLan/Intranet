                ...
                <div id="formInscription">
                    <form id="formModifProfil" class="formular" method="post" action="validformulaire.php">
                        ...
                        <fieldset>
                            ...
                            <input type="text" name="firstname" id="firstname" readonly value="{$joueur.prenom}"><br >

                            <label for="datepicker">Date de naissance :</label>
                            <input type="text" name="date" id="date" readonly value="{$joueur['date_de_naissance']}"><br >
                        ...
                        <fieldset>
                            ...
                            <input type="checkbox" class="jeux" name="tournois[]" id="LOL" disabled value="1">League Of Legends<br >
                                   <!--<?php echo isPlay($joueur['id_joueur'],"1",$connexion,$pseudoJeux); ?> -->
