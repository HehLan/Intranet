...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_570916e85b9c36_78428101',
  'file_dependency' => 
  array (
...
function content_570916e85b9c36_78428101 ($_smarty_tpl) {
?>
            ...
            <div class="row" id="contenu">
                <div id="bloc_news" class="col-lg-6 col-xs-12">
                    <h3>News</h3>
                        ...
                        <article class="panel panel-default une_news" role="article" id="bloc_news_1">
                            <header class="panel-heading header_news" id="titre_news_1" onclick="news_toggle(1);">
                                <h2 class="panel-title titre_news">fdgdf</h2>
                            </header>
                            <div class="panel-body contenu_news" id="contenu_news_1">
                                fdgfdgfdg
                            </div>
                            <footer class="panel-footer date_news" id="footer_news_1">
                                <small class="pull-right">samedi à 16h50</small>	
                            </footer>
			</article>
                                    </div>		
...
<script type="text/javascript" src="/Intranet/view/templates/default/assets/js/downloads.js"></script>
        ...
        <script type="text/javascript" src="/Intranet/view/templates/default/assets/js/index.js"></script>
                    <script type="text/javascript" src="/Intranet/view/templates/default/assets/js/chat.js"></script>
            </body>
</html><?php }
}
