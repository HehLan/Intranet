<?php
/* Smarty version 3.1.29, created on 2016-04-09 16:50:56
  from "E:\wamp\www\Intranet\view\templates\admin\index.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_570916d001aba0_79516969',
  'file_dependency' => 
  array (
...
function content_570916d001aba0_79516969 ($_smarty_tpl) {
?>
    ...
    <div class="container-fluid">
        ...
        <div id="container" class="container">
            ...
            <div id="contenu" class="row">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <img src="http://localhost:8080/Intranet/src/graphs/games_players_piegraph.php" />
                    </div>
                    <div class="col-lg-4">
                        <img src="http://localhost:8080/Intranet/src/graphs/games_teams_piegraph.php" />
                    </div>
                    <div class="col-lg-4">
                        <img src="http://localhost:8080/Intranet/src/graphs/games_bargraph.php" />
                    </div>
                </div>
            </div>
