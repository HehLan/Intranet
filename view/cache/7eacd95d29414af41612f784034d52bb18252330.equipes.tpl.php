...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_56fd1b9b5d2859_54163047',
  'file_dependency' => 
  array (
...
function content_56fd1b9b5d2859_54163047 ($_smarty_tpl) {
?>
...
<![endif]--> 
        ...
        <script type="text/javascript" src="/Intranet/view/templates/admin/assets/js/equipes.js"></script>		
    </head>
                        ...
                        <table class="listeEquipes">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div id="listeEquipeAdmin">
                                                                                            <h6 class="EquipeAdmin" value="118">50ShadesOfMurky</h6>
                                                                                            <h6 class="EquipeAdmin" value="126">BaraWeTrust</h6>
                                                                                            <h6 class="EquipeAdmin" value="119">Belgian Rape Squad</h6>
                                                                                            <h6 class="EquipeAdmin" value="115">DotFires</h6>
                                                                                            <h6 class="EquipeAdmin" value="117">Faglords Of Draenor</h6>
                                                                                            <h6 class="EquipeAdmin" value="122">Faglords Of Draenor.</h6>
                                                                                            <h6 class="EquipeAdmin" value="110">FricadellesDuPurgatoire</h6>
                                                                                            <h6 class="EquipeAdmin" value="120">Homard Team</h6>
                                                                                            <h6 class="EquipeAdmin" value="107">Les Gros Sandwiches</h6>
                                                                                            <h6 class="EquipeAdmin" value="121">Lunaria.Mix</h6>
                                                                                            <h6 class="EquipeAdmin" value="123">Lunastra</h6>
                                                                                            <h6 class="EquipeAdmin" value="127">Made In Belgium</h6>
                                                                                            <h6 class="EquipeAdmin" value="124">Mighty plo</h6>
                                                                                            <h6 class="EquipeAdmin" value="106">OmgTeam</h6>
                                                                                            <h6 class="EquipeAdmin" value="114">Police de la Luck</h6>
                                                                                            <h6 class="EquipeAdmin" value="116">Poulet Furieux</h6>
                                                                                            <h6 class="EquipeAdmin" value="111">R3surrection</h6>
                                                                                            <h6 class="EquipeAdmin" value="125">Red Devils</h6>
                                                                                            <h6 class="EquipeAdmin" value="113">Stonehenge</h6>
                                                                                            <h6 class="EquipeAdmin" value="112">Strutters</h6>
                                                                                    </div>
                                    </td>
                                    <td>
