...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_56f496b3e11210_72048569',
  'file_dependency' => 
  array (
...
function content_56f496b3e11210_72048569 ($_smarty_tpl) {
?>
...
<![endif]--> 
        <link rel="stylesheet" type="text/css" href="/Intranet/view/templates/admin/assets/css/downloads.css" >
    </head>
    <body role="document">
                ...
                <div id="bloc_update_downloads" class="col-lg-4 col-xs-12">
                            ...
                            <form class="well col-lg-12" method="POST" action="modules/downloads_save.php">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="title">Titre : </label>
                                        <input id="title" class="form-control" type="text" name="title"  value="aa">  
                                    </div>
                                    <div class="form-group">
                                        <label for="textarea">Source : </label>
                                        <textarea id="textarea" type class="form-control" name="textarea"></textarea>  
                                    ...
                                    <button class="btn btn-primary" type="submit">Save</button>
                                    <a class="btn btn-primary" href="modules/downloads_hide.php?invisible=1&id_downloads=8">Hide</a> 
                                    <small><p class="pull-right">Last update : 2016-03-24 01:10:48</p></small>                                    
                                </fieldset>
                            </form>
                            ...
                            <form class="well col-lg-12" method="POST" action="modules/downloads_save.php">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="title">Titre : </label>
                                        <input id="title" class="form-control" type="text" name="title"  value="fddf">  
                                    </div>
                                    <div class="form-group">
                                        <label for="textarea">Source : </label>
                                        <textarea id="textarea" type class="form-control" name="textarea">fsdf</textarea>  
                                    </div>
                                    <button class="btn btn-primary" type="submit">Save</button>
                                    <a class="btn btn-primary" href="modules/downloads_hide.php?invisible=1&id_downloads=7">Hide</a> 
                                    <small><p class="pull-right">Last update : 2016-03-24 01:10:35</p></small>                                    
                                </fieldset>
                            </form>
                            ...
                            <form class="well col-lg-12" method="POST" action="modules/downloads_save.php">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="title">Titre : </label>
                                        <input id="title" class="form-control" type="text" name="title"  value="ggggggggggggggg">  
                                    </div>
                                    <div class="form-group">
                                        <label for="textarea">Source : </label>
                                        <textarea id="textarea" type class="form-control" name="textarea">gggggggggggggg</textarea>  
                                    </div>
                                    <button class="btn btn-primary" type="submit">Save</button>
                                    <a class="btn btn-primary" href="modules/downloads_hide.php?invisible=1&id_downloads=5">Hide</a> 
                                    <small><p class="pull-right">Last update : 2016-03-20 23:08:39</p></small>                                    
                                </fieldset>
                            </form>
                            ...
                            <form class="well col-lg-12" method="POST" action="modules/downloads_save.php">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="title">Titre : </label>
                                        <input id="title" class="form-control" type="text" name="title"  value="hgfhf">  
                                    </div>
                                    <div class="form-group">
                                        <label for="textarea">Source : </label>
                                        <textarea id="textarea" type class="form-control" name="textarea">hfghf</textarea>  
                                    </div>
                                    <button class="btn btn-primary" type="submit">Save</button>
                                    <a class="btn btn-primary" href="modules/downloads_hide.php?invisible=1&id_downloads=2">Hide</a> 
                                    <small><p class="pull-right">Last update : 2016-03-20 22:57:54</p></small>                                    
                                </fieldset>
                            </form>
                ...
                <div id="bloc_deleted_downloads" class="col-lg-4 col-xs-12">
                            ...
                            <form class="well col-lg-12" method="POST" action="modules/downloads_save.php">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="title">Titre : </label>
                                        <input id="title" class="form-control" type="text" name="title"  value="hgf">  
                                    </div>
                                    <div class="form-group">
                                        <label for="textarea">Source : </label>
                                        <textarea id="textarea" type class="form-control" name="textarea">gfhgf</textarea>  
                                    </div>
                                    <button class="btn btn-primary" type="submit">Save</button>
                                    <a class="btn btn-primary" href="modules/downloads_hide.php?invisible=0&id_downloads=6">Unhide</a> 
                                    <a class="btn btn-primary" href="modules/downloads_delete.php?id_downloads=6">Delete</a> 
                                    <small><p class="pull-right">Last update : 2016-03-21 11:08:10</p></small>
                                </fieldset>
                            </form>
                            ...
                            <form class="well col-lg-12" method="POST" action="modules/downloads_save.php">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="textarea">Source : </label>
                                        <textarea id="textarea" type class="form-control" name="textarea">downloads/test.zip</textarea>  
                                    </div>
                                    <button class="btn btn-primary" type="submit">Save</button>
                                    <a class="btn btn-primary" href="modules/downloads_hide.php?invisible=0&id_downloads=1">Unhide</a> 
                                    <a class="btn btn-primary" href="modules/downloads_delete.php?id_downloads=1">Delete</a> 
                                    <small><p class="pull-right">Last update : 0000-00-00 00:00:00</p></small>
                                </fieldset>
                            </form>
